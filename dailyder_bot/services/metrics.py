...
class MetricsService:
    ...
    async def build_report(self, as_of_date: date, days: int = 30) -> str:
        ...
        snapshots = self._build_snapshots(users, submissions, workdays)
    ...
    def _build_snapshots(
        ...
        for user in users:
            snapshot = UserMetricsSnapshot(user=user)
